/**
 * Per-task chat scroll position (localStorage).
 * Keep-alive hides inactive sessions with display:none, which resets scrollTop —
 * so we persist and restore explicitly.
 */

const STORAGE_KEY = "kin.sessionScroll.v1";
